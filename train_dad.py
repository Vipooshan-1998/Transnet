...
def main():
	...
	# Define network
	model =  Trans_LSTM_Sans_Object(input_dim=opt.input_dim, embedding_dim=opt.embedding_dim, img_feat_dim=opt.img_feat_dim, num_classes=opt.num_classes).to(device)
	print(model)
